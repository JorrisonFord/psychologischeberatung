...
import { MessageCircle, Flower2, Palette } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.key}
                className={`group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift ${
